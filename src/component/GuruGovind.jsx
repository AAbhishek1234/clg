    ...
    <>
      ...
      <Container className="mt-5">
        <Row className="align-items-center">
          <Col md={8}>
            <h1 className="mb-4" style={{ fontWeight: "bold" }}>About Guru Gobind Singh Indraprastha University </h1>
            <p style={{ fontSize: "20px" }}>
            Guru Gobind Singh Indraprastha University has been established by Govt. of NCT of Delhi under the provisions of Guru Gobind Singh Indraprastha University Act, 1998. The University is recognized by the University Grants Commission (UGC), India under Section 2 (f) and 12 (b) of the UGC Act. The University graded as “A++” by the National Assessment and Accreditation Council,
             Bangalore for the period of 07 Years w.e.f 14.02.2023.
            </p>
          </Col>

          <Col md={4} className="text-center">
            <img 
              src='/Images/ggsi1.jpeg' 
              style={{ 
                height: "17rem", 
                width: "100%", 
                borderRadius: "10px" 
        ...
        <p style={{ fontSize: "20px" }}>
        GGSIPU Placements 2022 is concluded with 90% placements. Students received 370+ placement offers. GGSIPU highest package stood at INR 45 LPA whereas GGSIPU average package stood at INR 12 LPA. More than 70 recruiters participated in GGSIPU Placements 2022.
        The highest package offered during GGSIPU USICT placements in 2024 was INR 41.2 LPA, and the average package was INR 7.2 LPA. 32 companies visited the campus, and 126 offers were made. 
        </p>
        ...
        <p style={{ fontSize: "20px" }}>INR 41.2 LPA </p>
        <h3 className="mt-5 mb-3" style={{ fontWeight: "bold" }}>Average Package</h3>
        <p style={{ fontSize: "20px" }}>INR 7.2LPA</p>
