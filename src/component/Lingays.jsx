    ...
    <>
      ...
      <Container className="mt-5">
        <Row className="align-items-center">
          <Col md={8}>
            <h1 className="mb-4" style={{ fontWeight: "bold" }}>About  Lingaya’s Vidyapeeth </h1>
            <p style={{ fontSize: "20px" }}>
            Lingaya’s Vidyapeeth is a renowned educational institution dedicated to nurturing young minds and empowering them with knowledge, skills, and values. Established in the year 1998, our institution has a rich history of academic excellence and
             a commitment to fostering holistic development in students.The journey of Lingaya’s Vidyapeeth began with a vision to provide quality education and contribute to
              societal advancement by producing leaders, innovators, and responsible citizens.
        ...
        <p style={{ fontSize: "20px" }}>
        Lingaya's Vidyapeeth in Faridabad, Haryana, India, has a placement cell that aims to place 100% of its students.<br/>
        The university has a Corporate Resource Centre that offers career development initiatives, 
        including: Personalized counseling, Skill enhancement workshops, and Networking events.<br/>
        Lingaya's Vidyapeeth collaborates with major companies like Infosys, TCS, IBM, Huawei, and Google India for placements.
        </p>
