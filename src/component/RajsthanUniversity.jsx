    ...
    <>
      ...
      <Container className="mt-5">
        <Row className="align-items-center">
          <Col md={8}>
            <h1 className="mb-4" style={{ fontWeight: "bold" }}>About University of Rajasthan </h1>
            <p style={{ fontSize: "20px" }}>
            University of Rajasthan is a public and state university and one of the oldest university in the Indian state Rajasthan, located in the city Jaipur.of Rajasthan is a public and state university and one of the oldest university in the 
            Indian state Rajasthan, located in the city Jaipur.
        ...
        <p style={{ fontSize: "20px" }}>
        In 2022, the median package for UNIRAJ's UG 3-year program was INR 4.5 LPA and INR 6.35 LPA for the PG 2-year program.<br/>
        Some of the top recruiting companies for UNIRAJ include Tata, Infosys, Wipro, and Reliance. <br/>
        Roles offered to students are based on their skills and academics, with top roles being financial management and auditing.<br/>
        UNIRAJ offers courses in Arts, Science, Management, Law, Education, Humanities, Social Science, and other streams. It is famous for its flagship courses, which are MBA and BTech.
...
export default RajsthanUniversity