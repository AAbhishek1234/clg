    ...
    <>
      ...
      <Container className="mt-5">
        <Row className="align-items-center">
          <Col md={8}>
            <h1 className="mb-4" style={{ fontWeight: "bold" }}>About Deenbandhu Chhotu Ram University of Science and Technology, </h1>
            <p style={{ fontSize: "20px" }}>
            Deenbandhu Chhotu Ram University of Science and Technology (DCRUST), formerly Chhotu Ram State College of Engineering, Murthal (CRSCE), is a state university located in Murthal, Sonipat, Haryana, India. It was established in 2006 by an Act
             of the Government of Haryana, upgrading a 1986 established college.
             Dcrust is a tier-3 university but far better than private institutions especially in the terms of return on investment.
            </p>
          </Col>

          <Col md={4} className="text-center">
            <img 
              src='/Images/deenbandhu.jpeg' 
              style={{ 
                height: "17rem", 
                width: "100%", 
                borderRadius: "10px" 
        ...
        <p style={{ fontSize: "20px" }}>
        According to NIRF reports 2023, 177 UG (4 years), 54 UG (5 years), 80 PG (2 years) and 9 PG (5 years) students are placed and the median package
         offered is INR 4.5 LPA, INR 3.6 LPA, INR 4.5 LPA and INR 3.6 LPA respectively.<br/>
         the placement rate recorded during DCRUST BTech placements 2022 was 61%.</p>
        ...
        <p style={{ fontSize: "20px" }}>INR 24 LPA </p>
